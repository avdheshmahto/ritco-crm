  ...
  <div class="page page-core page-locked">
    ...
    <div class="container w-420 p-15 bg-white mt-40">
      <div class="bg-slategray lt wrap-reset mb-20 text-center">
        <h2 class="text-light text-greensea m-0">Reset Your Password!</h2>
      </div>
      <div class="media p-15">
        <div class="pull-left thumb thumb-lg mr-20"> <img class="media-object img-circle" src="<?=base_url();?>assets/assets/images/ici-avatar.jpg" alt=""> </div>
        <div class="media-body">
          ...
          <div class="form-group mt-10">
            <input type="hidden" name="emailid" value="<?=$email_id;?>" class="form-control underline-input">
            <input type="hidden" name="useridd" value="<?=$user_id;?>" class="form-control underline-input">
            <input type="password" name="entrpaswrd" id="entrpaswrd" placeholder="New Password" class="form-control underline-input" required="">
          ...
          <button type="button" onclick="validatePassword(this);" class="btn btn-greensea b-0 br-2 mr-5 block">Reset</button>
          </div>
          </form>
        </div>
      </div>
