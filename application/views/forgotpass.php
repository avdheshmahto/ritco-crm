...
<div id="wrap" class="animsition">
  <div class="page page-core page-login">
    ...
    <div class="container w-420 p-15 bg-white mt-40 text-center">
      ...
      <form method="post" class="form-validation mt-20" action="<?=base_url();?>master/Master/forgotPassword">
        <font color="#FF0000" style="display:marker"><b><?php echo $this->session->flashdata('message');?></b> </font>
        <p class="help-block text-left"> Enter your e-mail address below to reset your password. </p>
