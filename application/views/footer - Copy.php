...
$tskrmndr=$this->db->query("SELECT * FROM tbl_task WHERE SUBSTRING_INDEX(SUBSTRING_INDEX(
	reminder_date, ' ', 1), ' ', -1) = '$crdate' ");
//$RmndrCnt=$tskrmndr->num_rows();
...
$taskViewData = '<section class="block bottom20" style="padding: 15px;"><header class="head-title"><h2>Task Details</h2></header><div class="entity-detail"><table class="property-table"><tbody><tr><td class="ralign"><span class="title">Task Name :</span></td><td><div class="info">'.$getTname->keyvalue.'</div></td></tr><tr><td class="ralign"><span class="title">Assign To :</span></td><td><div class="info">'.$sqltask_ass_user->user_name.'</div></td></tr><tr><td class="ralign"><span class="title">Lead Name :</span></td><td><div class="info">'.$leadno.'</div></td></tr></tbody></table></div></section><section class="block bottom20" style="padding: 15px;"><header class="head-title"><h2>Additional Information</h2></header><div class="entity-detail"><table class="property-table"><tbody><tr><td class="ralign"><span class="title">Due Date:</span></td><td><div class="info">'.$getTask->date_due.'</div></td></tr><tr><td class="ralign"><span class="title">  Reminder: </span></td><td><div class="info">'.$getTask->reminder_date.'</div></td></tr><tr><td class="ralign"><span class="title"> Progress % : </span></td><td><div class="info">'.$getTask->progress_percnt.'</div></td></tr><tr><td class="ralign"><span class="title"> Priority : </span></td><td><div class="info">'.$progress_v->keyvalue.'</div></td></tr><tr><td class="ralign"><span class="title"> Status : </span></td><td><div class="info">'.$sqltask_status1->keyvalue.'</div></td></tr></tbody></table></div></section><div class="modal-footer"><a href="#" class="btn btn-default pull-left" data-dismiss="modal" onclick="getViewTaskPage('.$sqltask_id.');">View Task >></a><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div>';
...
<div class="media-heading m-0"> <a href="#" onClick="viewNotify(this);" data-toggle="modal" data-target="#myNotifyView" arrt='<?=json_encode($taskViewData);?>' class="mr-5"><?php echo $tnm." (".$leadno.")"; ?></a></div>
<small>Tasks - <?=$getTask->reminder_date; ?></small>  
...
<p>TODAY</p>	
  <div class="rmndrlead">
<div class="media-body">
<div class="media-heading m-0"> <a href="<?=base_url('lead/Lead/view_lead?id=');?><?=$getLead->lead_id; ?>" class="mr-5"><?php echo "Closure Lead (".$getLead->lead_number.")"; ?></a></div>
...
<div class="pull-left">
<div class="controls"> 
<label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0 mail-select">
<input type="checkbox">
<i></i></label>
</div>
</div>
<div class="media-body">
<div class="media-heading m-0"> <a href="mail-single.html" class="mr-5">Send Letter</a></div>
<small>Tasks - Nov 1</small>  
