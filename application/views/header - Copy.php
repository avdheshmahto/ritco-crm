...
<header class="clearfix">
    ...
    <ul class="nav-left pull-left list-unstyled list-inline">
	  <li class="sidebar-collapse divided-right"> <a href="#" class="collapse-sidebar"> <i class="fa fa-outdent"></i> <a class="brand" href="/ritco-crm/master/master/manage_dashboard"> <span><img src="/ritco-crm/assets/assets/images/techvyas-logo.png" alt=""></span> </a></a> </li>
    </ul>
    <!-- Left-side navigation end -->
    <!-- Search -->
    <div class="search" id="main-search">
      <input type="text" class="form-control underline-input" id="searchTerm1" onKeyUp="doSearch1()" placeholder="Search...">
    </div>
