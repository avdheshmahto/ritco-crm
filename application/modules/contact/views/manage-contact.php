...
{
?>
<button class="btn btn-danger mb-10" data-toggle="modal" data-target="#contactModal" formid="#ContactForm" id="formreset">Add New Contact</button>
<?php } ?>
</div>
<div class="btn-group">
  <?php
...
Show
<select class="btn btn-default btn-sm" name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries"  url="<?=base_url('contact/Contact/manage_contact?');?>">
...
?>
<tr class="record" data-row-id="<?php echo $fetch_list->contact_id; ?>">

<td>
  <label class="checkbox checkbox-custom-alt checkbox-custom-sm m-0">
    <input name="cid[]" type="checkbox" id="cid[]" class="sub_chk" data-id="<?php echo $fetch_list->contact_id; ?>" value="<?php echo $fetch_list->contact_id;?>">
    <i></i>
  </label>
</td>
<td>
<?php
$string=$fetch_list->contact_name;
$firstCharacter = $string[0];
?>
<!-- <a href="#" onclick="getViewContactPage('<?=$fetch_list->contact_id;?>');"> -->
<a href="<?=base_url('contact/Contact/view_contact?id=');?><?=$fetch_list->contact_id; ?>">
<div class="thumb thumb-sm">
<div class="img-circle bg-blue circle"><?=$firstCharacter?></div>
</div>
</a>
</td>
<td>
  <a href="<?=base_url('contact/Contact/view_contact?id=');?><?=$fetch_list->contact_id; ?>"><?=$fetch_list->contact_name;?></a>
</td>
<td>
  <?php echo $fetch_list->designation; ?>
</td>
<?php
$org=$this->db->query("select * from tbl_organization where org_id='".$fetch_list->org_name."' ");
$getOrg=$org->row();
 ?>
<td><?=$getOrg->org_name;?></td>
...
{
?>
  <li><a href="#" onclick="editContact(this);" property = "edit" type="button" data-toggle="modal" data-target="#contactModal" arrt= '<?=json_encode($fetch_list);?>'  data-backdrop='static' data-keyboard='false'><i class="fa fa-edit"></i> Edit This Contact</a></li>
<?php } ?>
...
<?php } else { ?>
  <li><a href="#" class="delbutton_cntct" id="<?php echo $fetch_list->contact_id."^".$table_name."^".$pri_col ; ?>"><i class="fa fa-trash"></i> Delete This Contact </a></li>
<?php } ?>
<?php } ?>
</ul>
</div>
