...
<!-- Modal taskEditModal -->
<div class="modal fade" id="taskEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<!-- Modal Notes -->
<div class="modal fade" id="taskNoteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
<div class="modal-dialog modal-lg" role="document">
<div class="modal-content">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
...
<input type="text" name="tskid" id="tskid" value="<?=$task_id?>">
<input type="text" name="main_id" id="main_id" value="" >
<input type="text" name="noteid" id="noteid" value="" class="hiddenField">
</div>
<div class="form-group col-md-6">
...
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
<button type="submit" id="tasknotesave" class="btn btn-primary">Save</button>
<span id="tasknoteload" style="display: none;">
<img src="<?=base_url('assets/loadgif.gif');?>" alt="HTML5 Icon" width="54.63" height="40">
</span>
</div>
</form>
...
<!-- Modal Files -->
<div class="modal fade" id="fileTaskModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
<div class="modal-dialog modal-lg" role="document">
<div class="modal-content">
...
<input type="hidden" name="tskid" id="tskid" value="<?=$task_id?>">
...
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
<button type="submit" id="filetasksave" class="btn btn-primary">Save</button>
<span id="filetaskload" style="display: none;">
<img src="<?=base_url('assets/loadgif.gif');?>" alt="HTML5 Icon" width="54.63" height="40">
</span>
</div>
</form>
...
$(document).ready(function(){
  ...
  //   {
  //   $("#status").val("20").trigger('chosen:updated');   
  //   }
  //   else if(progress==0)
  //   {
  //     $("#status").val("33").trigger('chosen:updated'); 
  //   }
  //   else
  //   {
  //     $("#status").val("21").trigger('chosen:updated');   
  //   }
