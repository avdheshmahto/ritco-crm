...
else
{
	if($this->session->userdata('role') == 1){
	  ...
	  $leadstg=$this->db->query("select *,count('stage') as countval from tbl_leads where status='A' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) GROUP BY stage");	
	}
}
...
if($_GET['filterstg'] == 'filterstg')
{
	...
	//echo $lead;
		...
		$ttld=$this->db->query("select * from tbl_leads where status='A' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getTotalLead=$ttld->num_rows();

		$nwopp=$this->db->query("select * from tbl_leads where status='A' and stage='17' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getNewOpp=$nwopp->num_rows();

		$cnting=$this->db->query("select * from tbl_leads where status='A' and stage='18' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getCnting=$cnting->num_rows();

		$rates=$this->db->query("select * from tbl_leads where status='A' and stage='53' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getRates=$rates->num_rows();

		$clsd=$this->db->query("select * from tbl_leads where status='A' and stage='78' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getClsd=$clsd->num_rows();
	}
...
else
{
	...
	if($this->session->userdata('role') == 1){
	  ...
	  $leadsts=$this->db->query("select *,count('lead_state') as countval from tbl_leads where status='A' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) GROUP BY lead_state ");
	}	
...
else
{
   if($this->session->userdata('role') == 1){
	...
	//=============
   	...
   	//=============
	$totalds=$this->db->query("select * from tbl_leads where status='A' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
	$getTtlLead=$totalds->num_rows();

	$opn=$this->db->query("select * from tbl_leads where status='A' and lead_state='65' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
	$getOpn=$opn->num_rows();

	$won=$this->db->query("select * from tbl_leads where status='A' and lead_state='66' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
	$getWon=$won->num_rows();

	$lost=$this->db->query("select * from tbl_leads where status='A' and lead_state='67' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
	$getLost=$lost->num_rows();

	$frz=$this->db->query("select * from tbl_leads where status='A' and lead_state='79' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
	$getFreeze=$frz->num_rows();
	//=============
   }
...
else
{
	if($this->session->userdata('role') == 1){
	  ...
	  $tasknm=$this->db->query("select task_name,count('task_name') as countval from tbl_task where status='A' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) GROUP BY task_name");	
	}
}
...
if($_GET['filtertask'] == 'filtertask')
{
	...
	//echo $lead;
		...
		$ttltask=$this->db->query("select * from tbl_task where status='A' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getTtlTask=$ttltask->num_rows();

		$phncall=$this->db->query("select * from tbl_task where status='A' and task_name='23' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getPhnCall=$phncall->num_rows();

		$email=$this->db->query("select * from tbl_task where status='A' and task_name='24' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getEmail=$email->num_rows();

		$meeting=$this->db->query("select * from tbl_task where status='A' and task_name='25' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getMeeting=$meeting->num_rows();

		$deadline=$this->db->query("select * from tbl_task where status='A' and task_name='31' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getDeadline=$deadline->num_rows();

		$followup=$this->db->query("select * from tbl_task where status='A' and task_name='57' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getFolloup=$followup->num_rows();
...
else
{
	if($this->session->userdata('role') == 1){
	  ...
	  $tasksts=$this->db->query("select task_status,count('task_status') as countval from tbl_task where status='A' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) GROUP BY task_status");	
	}
}
...
if($_GET['filtertasksts'] == 'filtertasksts')
{
	...
	//echo $lead;
		...
		$totaltask=$this->db->query("select * from tbl_task where status='A' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getTotalTask=$totaltask->num_rows();

		$ntstrt=$this->db->query("select * from tbl_task where status='A' and task_status='19' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getNotStrtd=$ntstrt->num_rows();

		$inprgrs=$this->db->query("select * from tbl_task where status='A' and task_status='20' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getPrgrs=$inprgrs->num_rows();

		$cmplt=$this->db->query("select * from tbl_task where status='A' and task_status='21' AND (maker_id='".$this->session->userdata('user_id')."' OR brnh_id='".$this->session->userdata('brnh_id')."' OR user_resp='".$this->session->userdata('user_id')."' ) ");
		$getCmplt=$cmplt->num_rows();
	}
